...
import (
	...
	"gin-demo/study/gen/model/entity"
)
...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.UserKey = field.NewString(tableName, "user_key")
	_user.UserSecret = field.NewString(tableName, "user_secret")
...
type user struct {
	...
	Gender       field.Int32  // 性别 0-保密 1-男 2-女
	UserRole     field.String // 用户角色：user / admin
	UserPassword field.String // 密码
	UserKey      field.String // key
	UserSecret   field.String // secret
	CreateTime   field.Time   // 创建时间
	UpdateTime   field.Time   // 更新时间
	IsDelete     field.Field  // 是否删除
...
func (u *user) updateTableName(table string) *user {
	...
	u.UserSecret = field.NewString(table, "user_secret")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["user_secret"] = u.UserSecret
