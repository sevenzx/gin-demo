...
func newTodo(db *gorm.DB, opts ...gen.DOOption) todo {
	...
	_todo.CreateTime = field.NewTime(tableName, "create_time")
	_todo.UpdateTime = field.NewTime(tableName, "update_time")
	_todo.IsDelete = field.NewField(tableName, "is_delete")
...
func (t todoDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) ITodoDo {
